...
window.initBackground = function initBackground() {
  ...
  const MONUMENTS = [
    { file: "burj-khalifa.svg",  section: "hero",     depth: 0.4,  x: 78, y: 18, size: 46, op: 0.16, float: true },
    { file: "dubai-frame.svg",   section: "hero",     depth: 0.15, x: 14, y: 30, size: 30, op: 0.10 },
