...
window.initProducts = function initProducts() {
  ...
  const CATS = ["All", "Rice", "Oil", "Palm Oil", "Fruits", "Spices", "Sugar"];
  ...
  const cardHTML = (p) => {
    ...
    <article class="card product-card has-filigree" data-cat="${esc(p.category)}" data-slug="${esc(p.slug)}" data-reveal>
      <div class="media">
        ...
        <img src="${esc(img.url)}" alt="${esc(img.alt || p.name)}" loading="lazy" decoding="async">
      </div>
      <div class="body">
    ...
    modal.innerHTML = `
      <div class="modal-panel" role="document">
        ...
        <div class="modal-grid">
          <div class="modal-gallery"><img src="${esc(img.url)}" alt="${esc(img.alt || p.name)}"></div>
